...
<body>
    ...
    <section class="from-blog spad">
        <div class="container">
            ...
            <div style="width:100%; height:100%; text-align:center; display:inline-block; margin-bottom:30px">
            	<div id="naver_id_login" style="text-align:center; display:inline-block;"><a href="${url}"><img src="img/login_naver.png"/></a></div>
				<div id="kakao_id_login" style="text-align:center; display:inline-block;"><a href="https://kauth.kakao.com/oauth/authorize?client_id=cab40a487624fe914d53ae28da0663b8&redirect_uri=http://localhost:8080/Project_2nd/kakao.ns&response_type=code"><img src="img/login_kakao.png"/></a></div>
            </div>
