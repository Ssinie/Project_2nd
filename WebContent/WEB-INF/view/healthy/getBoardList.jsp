...
$(document).ready(function() {
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="/Project_2nd/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="/Project_2nd/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="/Project_2nd/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="/Project_2nd/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="/Project_2nd/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="/Project_2nd/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="/Project_2nd/css/slicknav.min.css" type="text/css">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li class="active"><a href="/Project_2nd/healthy/getBoardList.ns">건강뉴스</a></li>
            </ul>
        </nav>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
    ...
    <!-- Js Plugins -->
    <script src="/Project_2nd/js/jquery-3.3.1.min.js"></script>
    <script src="/Project_2nd/js/bootstrap.min.js"></script>
    <script src="/Project_2nd/js/jquery.nice-select.min.js"></script>
    <script src="/Project_2nd/js/jquery-ui.min.js"></script>
    <script src="/Project_2nd/js/jquery.slicknav.js"></script>
    <script src="/Project_2nd/js/mixitup.min.js"></script>
    <script src="/Project_2nd/js/owl.carousel.min.js"></script>
    <script src="/Project_2nd/js/main.js"></script>
