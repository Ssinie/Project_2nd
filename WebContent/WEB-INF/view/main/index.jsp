...
<head>
  ...
  <link rel="stylesheet" href="fonts/index/icomoon/style.css">

  <link rel="stylesheet" href="css/index/bootstrap.min.css">
  <link rel="stylesheet" href="fonts/index/flaticon/font/flaticon.css">
          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0">내 몸에 필요한 <strong class="text-primary">영양제</strong> 찾고 계신가요?</h1>
                ...
                <p style="display:inline-block"><a href="question/pForm.do" class="btn btn-primary px-5 py-3">설문조사 시작</a></p>
