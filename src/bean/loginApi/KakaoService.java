...
public class KakaoService {
        ...
        public String getAccessToken (String authorize_code) throws Exception{
            ...
            try {
                ...
                sb.append("&client_id=cab40a487624fe914d53ae28da0663b8");  //본인이 발급받은 key
                sb.append("&redirect_uri=http://localhost:8080/Project_2nd/kakao.ns");     // 본인이 설정해 놓은 경로
